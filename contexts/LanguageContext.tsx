...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    // Model Config
    "setup.modelConfig": "模型配置",
    "setup.provider": "模型厂商",
    "setup.modelName": "模型名称 (可选)",
    "setup.modelNamePlaceholder": "如留空则使用默认模型",
  ...
  en: {
    ...
    // Model Config
    "setup.modelConfig": "Model Configuration",
    "setup.provider": "Provider",
    "setup.modelName": "Model Name (Optional)",
    "setup.modelNamePlaceholder": "Leave empty for default",

    "app.title": "AI Business Insight",
